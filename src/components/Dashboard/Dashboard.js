    ...
    return (
        <div>
            <div className='dashboard-bg'>
                ...
                <div className='dashboard-main d-md-flex'>
                    <div className='dashboard-survey col-10 col-md-5 ml-4 ml-md-0'>
                        <h1>My Surveys</h1>
                        <div>
                            <div className='dash-card '>
                                {
                                    props.survey ?
                                        props.survey.map(obj => (
                                            <Card key={obj.id} className='col-md-6 col-10 '>
                    ...
                    <div className='dashboard-profile col-10 col-md-5 ml-4 ml-md-0 mt-3 mt-md-0'>
                        <h1>My Profile</h1>
